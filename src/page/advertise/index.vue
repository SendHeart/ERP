  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="homeAdvertiseTable"
        ...
        <el-table-column :label="$t('commons.news_title')" align="center">
          <template slot-scope="scope">{{scope.row.title}}</template>
        </el-table-column>
        <el-table-column :label="$t('commons.news_content')" width="120" align="center">
          <template slot-scope="scope">{{scope.row.content}}</template>
        </el-table-column>
        <el-table-column :label="$t('commons.news_pic')" width="120" align="center">
			<template slot-scope="scope">
				<img style="height: 80px" :src="scope.row.pic">
			</template>
        </el-table-column>
        <el-table-column :label="$t('commons.news_duration')" width="220" align="center">
          <template slot-scope="scope">
