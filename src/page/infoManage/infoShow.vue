<template>
    <div class="fillcontain">
        ...
        <el-row class="data_row row" :gutter="10">
                <el-col :span="6">
                <div class="area">
                    <p class="title"><svg-icon icon-class="pay3" />待收资产</p> 
                ...
                <el-col :span="6">
                    <div class="area">
                    <p class="title"><svg-icon icon-class="iconpay3" />账户总资产</p>
                ...
                <el-col :span="6">
                    <div class="area">
                    <p class="title"><svg-icon icon-class="iconpay3" />已得回报</p>
                ...
                <el-col :span="6">
                <div class="area">
                    <p class="title"><svg-icon icon-class="iconpay3" />期待回报</p>
