const github = '';
const sendemail = 'mailto:rixzhang@dreamer-inc.com?subject=这是邮件的主题&body=这是邮件的内容';
const qqcodeUrl = 'http://wpa.qq.com/msgrd?v=3&uin=198895160&site=qq&menu=yes';
const appUrl = process.env.VUE_APP_URL  // development和production环境是不同的
const shop_type = '10'  //送心平台ERP
